...
```{r}
bitcoin = crypto_large[crypto_large$crypto == "BTC", ]
ethereum = crypto_large[crypto_large$crypto == "ETH", ]
plot(bitcoin$unix_time, bitcoin$candlestick_high, col = "black", type = "l",
     xlab = "time",
     ylab = "value",
     ylim = c(0, 100000))
points(ethreum$unix_time, ethereum$candlestick:high, col = "blue", type = "l") 
```
